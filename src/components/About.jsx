      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 relative group w-full max-w-md lg:max-w-none">
            ...
            {/* Experience Badge */}
            <div className="absolute -bottom-10 left-10 z-20 bg-[#1e293b] border border-white/10 p-6 rounded-2xl shadow-2xl backdrop-blur-xl hidden sm:block">
          ...
          <div className="flex-[1.2] text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 gap-4 mb-12">
              {stats.map((stat, index) => (
                <div 
                  key={index}
                  className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-sky-400/30 transition-all duration-300 group text-left"
                >
            ...
            {/* Resume Button */}
            <button className="group relative px-10 py-4 bg-transparent border-2 border-sky-400 text-sky-400 font-bold rounded-2xl overflow-hidden transition-all duration-300 hover:text-[#0f172a] active:scale-95">
