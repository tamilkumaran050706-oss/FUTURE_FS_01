  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 text-center">
        ...
        {/* Main Heading */}
        <div>
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-white mb-8 tracking-tight leading-[1.1]">
            Hi, I'm <span className="text-sky-400 relative inline-block">
              Tamil Kumaran
            </span>
          </h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
          <Link to="projects" smooth={true} duration={500} offset={-80}>
            <button className="group relative px-10 py-4 bg-sky-400 text-[#0f172a] font-bold rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(56,189,248,0.4)] active:scale-95 cursor-pointer overflow-hidden">
        ...
        <div className="flex items-center justify-center gap-8">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-500 hover:text-sky-500 transition-all duration-300"
            aria-label="LinkedIn"
          >
