        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="flex-1 space-y-12">
            <div className="space-y-8">
              ...
              <a 
                ...
                className="group flex items-center gap-6 p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-sky-400/30 transition-all duration-300"
              >
          ...
          <div className="flex-[1.5]">
            <form className="p-8 sm:p-10 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl shadow-2xl space-y-6">
              ...
              <button 
                type="button"
                className="w-full group relative px-10 py-5 bg-sky-400 text-[#0f172a] font-black rounded-2xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_20px_40px_rgba(56,189,248,0.2)] active:scale-95"
              >
